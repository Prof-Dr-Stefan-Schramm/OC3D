...
> Schramm, S. *OC3D — Organic Chemistry in Interactive 3D* (Version 1.0.0) [Computer software]. Zenodo. https://doi.org/10.5281/zenodo.XXXXXXX *(DOI is assigned with the first Zenodo-archived release — replace placeholder)*
